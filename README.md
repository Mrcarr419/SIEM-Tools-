...
# I created a VM using Azure nad a container for it all. Opened a RDP and left open to invite incoming traffic to have threats to assess. Used a GUI to read all activity going into the hub I created. Created a data connector for log injustion with data collection rules. I reviewed and assesed all vulnerabilities that was available, remediated 
